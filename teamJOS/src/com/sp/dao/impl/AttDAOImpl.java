...
public class AttDAOImpl implements AttDAO{
	...
	public int insertVacation(VacationDTO vacation) throws SQLException{
		...
		try {
			...
			sql = """
					INSERT INTO /* ATT_INS_008 */ TB_VACATION(VACATION_SEQ, EMP_NO, START_DT, END_DT, VACATION_MEMO, APPROVER_YN) VALUES(SQ_TB_VACATION.NEXTVAL, ?, TO_TIMESTAMP(?, 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP(?, 'YYYY-MM-DD HH24:MI:SS'), ?, 'N')
					""";
